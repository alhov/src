...
class QBN:
    ...
    def listArcs(self):
        """
        Returns the list of arcs in the network.

        Returns:
            list [Tuple(str,str)]: The list of arcs in the network.
    ...
    def verifcpt(self, var):
        ...
        while I.todict() != initial:
            ...
            quad = quad + r*r
            I.inc()
        # Checking the sum of squares of modules in the last row
        if round(quad, 5) != 1:
            print("Invalid module")
            return False
        return True
