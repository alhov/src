...
class MyTest(unittest.TestCase):
    def test_unit(self):
        ...
        infer_exacte.addTarget("E")
        infer_exacte.addTarget("F")
        infer_exacte.addTarget("G")
        infer_exacte.addTarget("C")
        infer_exacte.addTarget("J")
        infer_exacte.makeInference()
        self.assertEqual(round(infer_exacte.posterior("B")[0] + infer_exacte.posterior("B")[1], 5), 1)
        self.assertEqual(round(infer_exacte.posterior("H")[0]+ infer_exacte.posterior("H")[1], 10), 1)
        self.assertEqual(round(infer_exacte.posterior("A")[0] + infer_exacte.posterior("A")[1], 5), 1)
        self.assertEqual(round(infer_exacte.posterior("E")[0]+ infer_exacte.posterior("E")[1], 10), 1)
