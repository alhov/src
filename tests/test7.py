...
class MyTest(unittest.TestCase):
    def test_unit(self):
        ...
        self.assertEqual(rb.verifcpt("D"), True)
        self.assertEqual(rb.verifcpt("E"), True)
        self.assertEqual(rb.verifcpt("A"), True)
        self.assertEqual(rb.verifcpt("B"), True)
        self.assertEqual(rb.verifcpt("C"), True)
